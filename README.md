# TNT Italy Tracking API For PHP
TNT Italy Tracking API and webhook make it easy to integrate TNT Italy Tracking function into your own project. Support APIs Client Libraries for php

### API key

In order to use this API, you need to generate a TNT Italy Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use TNT Italy Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [TNT Italy Tracking API](https://www.trackingmore.com/tnt-it-tracking.html)  to:

   *   Get TNT Italy realtime tracking info of muti-carriers in one integration
   *   Provide TNT Italy shipment tracking experience like Amazon
   *   Push TNT Italy notifications of package update with webhook
   *   Verify TNT Italy delivery exception before it is too late
